...
import jbDonstore from './img/jb-donstore.png';
import ds from './img/ds.png';

const Donstore = () => {
  return (
    <>
      <title>Donstore | Portfolio</title>
      <div class="container-boola">
        <div class="jumbotron ">
          <img src={jbDonstore} alt="jb-movies" className="img-fluid" />
        </div>
        <div class="container-custom-boola">
          <div class="content-boola">
            ...
            <img src={ds} alt="header-movies" className="img-fluid mb-5" />
